...
namespace Scada.Comm.Devices.DbImportPlus.Configuration
{
    /// <summary>
    ...
    internal class KpConfig
    {
        ...
        /// </summary>
        public bool KPTagsBasedRequestedTableColumns { get; set; }
        ...
        public bool Load(string fileName, out string errMsg)
        {
            ...
            try
            {
                ...
                KPTagsBasedRequestedTableColumns = rootElem.GetChildAsBool("KPTagsBasedRequestedTableColumns");
        ...
        public bool Save(string fileName, out string errMsg)
        {
            try
            {
                ...
                XmlElement rootElem = xmlDoc.CreateElement("KpDbImportPlusConfig");
                ...
                rootElem.AppendElem("KPTagsBasedRequestedTableColumns", KPTagsBasedRequestedTableColumns);
        ...
        public int CalcTagCount()
        {
            ...
            {
                if (KPTagsBasedRequestedTableColumns)
                {
        ...
        {
            return Path.Combine(configDir, "KpDbImportPlus_" + CommUtils.AddZeros(kpNum, 3) + ".xml");
        }
    }
}
